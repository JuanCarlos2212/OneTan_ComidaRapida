...
public class RegistroExitoso extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSEmpezar= findViewById(R.id.btnEmpezarReExitoso);

        guardarpreferencias();

        btnSEmpezar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(RegistroExitoso.this, MainActivityRepartidor.class);
    ...
    private void guardarpreferencias() {
        ...
        JsonArrayRequest jsonArrayRequest = new JsonArrayRequest(URLusuario, new Response.Listener<JSONArray>() {
            ...
            public void onResponse(JSONArray response) {
                ...
                for (int i = 0; i < response.length(); i++) {
                    ...
                    try {
                        ...
                        Toast.makeText(RegistroExitoso.this, "esta entrando al catch", Toast.LENGTH_SHORT).show();
                    }
                }
            }
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(RegistroExitoso.this, "Error en la conexion", Toast.LENGTH_SHORT).show();
            }
        });
